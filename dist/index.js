...
var AudioDecoder = /** @class */ (function () {
    ...
    AudioDecoder.prototype.decode = function (device, type, arecordOptions, multimonOptions) {
        ...
        return {
            process: process,
            data: new rxjs_1.Observable(function (observer) {
                var _a;
                (_a = process.stdout) === null || _a === void 0 ? void 0 : _a.on('data', function (message) { return observer.next(message.trim()); });
...
(function (MultimonModeEnum) {
    ...
    MultimonModeEnum["APRS"] = "AFSK1200";
